...
def launch_scrcpy(device_id: str = None):
    """Launch scrcpy for live screen mirroring and device control."""
    ...
    console.print("[bold green]Launching scrcpy...[/] Close the scrcpy window to return.")
    try:
        return subprocess.call(cmd) == 0
    except FileNotFoundError:
        console.print("[bold red]Unable to start scrcpy.[/]")
        return False
