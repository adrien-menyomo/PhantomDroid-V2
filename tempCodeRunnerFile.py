...
MENU_OPTIONS = [
    ...
    ("15", "🪟", "scrcpy Launcher",         "Mirror and control the device live"),
    ("16", "ℹ️ ", "About",                  "About PhantomDroid"),
...
Examples:
  ...
  python3 phantomdroid.py --devices
    ...
    dg.add_argument("--scrcpy",            action="store_true",    help="Launch scrcpy for live screen mirroring")
